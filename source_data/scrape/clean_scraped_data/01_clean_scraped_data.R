...
ps_import <- read_csv("source_data/scrape/scraped_ps_data.csv", na = "")
...
write_csv(missing_ps, "analysis/validity_checks/ps_sequence_gaps.csv")
...
write_csv(unique_PS, "analysis/validity_checks/unique_PS_coords.csv")
...
write_csv(province_summary, "analysis/validity_checks/province_voter_reg.csv")
...
write_csv(constituency_summary, "analysis/validity_checks/constituency_voter_reg.csv")
...
ps_data %>%
  ...
  write_csv("analysis/validity_checks/existing_constituencies.csv")

write_csv(ps_data, "analysis/01d_scraped_ps_data.csv")
